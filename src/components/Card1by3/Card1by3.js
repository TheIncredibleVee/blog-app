...
const Card1by3 = ({heading, desc, authorName, mini, image, authorImage, category,idx}) => {
        ...
        <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                <Link to={idx===-1?path:`/post/${idx+1}`}  className="flex flex-wrap no-underline hover:no-underline">
                    <img src={image} className="h-64 w-full rounded-t pb-6" alt="post"/>
